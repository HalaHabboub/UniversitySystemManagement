...
namespace UniversitySystemManagement.Controllers
{
    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HireDate,DepartmentId,Id,FirstName,LastName,Email")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HireDate,DepartmentId,Id,FirstName,LastName,Email")] Instructor instructor)
        {
            if (id != instructor.Id)
            {
                return NotFound();
